...
def robust_lstm(train_scaled,test_scaled,scaler,raw_values):
	'''
	Function that takes in input:
	- 
	- 
	...
	and perform the model fitting and the walk forward validation into a loop, doing it for 10 times.
